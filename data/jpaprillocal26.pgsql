...
257	257	/images/angel1.png			emptyunit0.png
...
300	300	/images/leo0.png	/images/leo1.png		emptyunit0.png
...
242	242	Wood type allies Debuff Evasion +15%	Deals 242 damage	Deals 1124 damage to target, 62.7% chance to remove a debuff from 3 Wood type allies	Deals 1538 damage to target, prioritizing 2 lowest HP allies, apply regen 2.2% HP + 74 for 14s and 5 Wood type allies + 14.1% Debuff Evasion	Deal 3971 damage to 2 random enemies, prioritizing 3 lowest HP allies, heal 2018 HP and if allies are debuffed, apply regen 370HP for 16s	
239	239	Water type allies Slide Skill Defense +12%	Deals 93 damage	Deals 322 damage to target, prioritizing 2 lowest HP allies, give Max HP +850 for 8s	Deals 606 damage to target, for 3 lowest HP Water type allies, apply Ice-Shield and Max HP +1400 for 14s	Deal 1536 damage to 3 random enemies, grant taunt to herself and apply Ice-Shield (Def +45% and for 8s, when attacked, enemy Skill Gauge Charge speed -40%) for 16s	
235	235	Fire type allies Skill Gauge Charge Speed +15%	Deals 101 damage	Deals 391 damage to target, 60% chance of remove DoT Debuffs from 2 allies	Deals 704 damage to 2 random enemies, for 2 highest attack Fire type allies apply Double-Edge-Sword and Skill Gauge +20%. For Ragna only, additional Tap skill damage +30% for 16s	Deal 1826 damage to 3 random enemies, for 3 highest attack Fire type allies, Skill Gauge Charge Speed +60%. For Ragna only, Final Tap skill damage +30% for 20s	Her Slide and Drive's Tap Skill damage stacks
...
311	311	Fire type allies Slide Skill Damage +12%(For WB only, Slide Skill Damage additional +12%)	Deals 113 damage	Deals 492 damage to target, for WB only, grant Skill Damage +25% to self for 14s	Deals 959 damage 2 times and 400 Ignore Defense damage to 2 random enemies. If the target is Wood type, deal 350 Bonus damage. For WB only, apply Protection-buff-explosion.	Deal 2601 damage to all enemies, for WB only, apply Protection-buff-explosion.	Same type of buff explosion as "Ophois"
307	307	Wood type allies Drive Defense +15% (for PvP only, additional +20%)	Deals 93 damage	Deals 322 damage to target, for the highest wood type ally, grant Immortality for 10s	Deals 593 damage to target, for 3 lowest HP allies, 56% chance to grant Immortality for 14s and for 3 lowest HP Wood allies, Max HP +1600 for 14s	Deal 1511 damage to 2 random enemies, 95% chance to give Immortality to self for 16s. Taunt for 16s. 70% chance to give Debuff-Taunt to self	
...
305	305	Fire type allies Tap skill damage +15% (For Ragna only)	Deals 114 damage	Deals 492 damage to target 3 times, deal 500 Ignore defense damage, and for Wood type targets, deal 350 Bonus damage. For Ragna only, 70% chance to apply Overload to self for 14s	Deals 961 damage to 3 random enemies, apply Fortitude-Explosion.	Deal 2607 damage to all enemies, for Attacker types, deal 700 Bonus damage Lead	
300	300	Water type allies Weak Point damage +15%  (For Ragna only, Weak Point damage additional +20%)	Deals 101 damage	Deals 395 damage to target, skill gauge +18% to 2 water type allies, excluding itself and 60% chance to apply Purification to 2 allies with the Bleeding status.	Deals 719 damage to target, for 3 highest attack water type allies, Skill gauge charge Speed +40% and Weak point damage +25% for 2 turns. For Ragna only, Slide skill damage +50%	Deal 1860 damage to 3 random enemies, for 3 lowest remaining allies, Regen 285 HP for 16s. For Ragna only, for the highest attacker water ally, Tap skill damage +80%	trap costume :mmmm:
314	314	Attack type allies slide skill cooldown reduced by 1 second	Deals 113 damage.	Deals 492 damage to target, 65% chance to grant Cheer to self for 15s.	Deals 958 damage to 2 enemies with the lowest HP, deals 1300 ignore DEF damage. For WB only, deal Hope-passage.	Deal 2600 damage to all enemies	Translator note/rant: for whatever reason for that slide they changed to wording to make it "look" like bigger numbers but works like any other WB attacker (for every light ally deal 500 bonus damage, up to 10x)
