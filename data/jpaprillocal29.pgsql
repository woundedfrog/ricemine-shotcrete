...
--
-- Name: mainstats; Type: TABLE; Schema: public; Owner: doadmin
--
...
ALTER TABLE public.mainstats OWNER TO doadmin;

--
-- Name: mainstats_id_seq; Type: SEQUENCE; Schema: public; Owner: doadmin
--
...
ALTER TABLE public.mainstats_id_seq OWNER TO doadmin;

--
-- Name: mainstats_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: doadmin
--
...
--
-- Name: profilepics; Type: TABLE; Schema: public; Owner: doadmin
--
...
ALTER TABLE public.profilepics OWNER TO doadmin;

--
-- Name: profilepics_id_seq; Type: SEQUENCE; Schema: public; Owner: doadmin
--
...
ALTER TABLE public.profilepics_id_seq OWNER TO doadmin;

--
-- Name: profilepics_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: doadmin
--
...
--
-- Name: scstats; Type: TABLE; Schema: public; Owner: doadmin
--
...
ALTER TABLE public.scstats OWNER TO doadmin;

--
-- Name: scstats_id_seq; Type: SEQUENCE; Schema: public; Owner: doadmin
--
...
ALTER TABLE public.scstats_id_seq OWNER TO doadmin;

--
-- Name: scstats_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: doadmin
--
...
--
-- Name: soulcards; Type: TABLE; Schema: public; Owner: doadmin
--
...
ALTER TABLE public.soulcards OWNER TO doadmin;

--
-- Name: soulcards_id_seq; Type: SEQUENCE; Schema: public; Owner: doadmin
--
...
ALTER TABLE public.soulcards_id_seq OWNER TO doadmin;

--
-- Name: soulcards_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: doadmin
--
...
--
-- Name: substats; Type: TABLE; Schema: public; Owner: doadmin
--
...
ALTER TABLE public.substats OWNER TO doadmin;

--
-- Name: substats_id_seq; Type: SEQUENCE; Schema: public; Owner: doadmin
--
...
ALTER TABLE public.substats_id_seq OWNER TO doadmin;

--
-- Name: substats_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: doadmin
--
...
--
-- Name: units; Type: TABLE; Schema: public; Owner: doadmin
--
...
ALTER TABLE public.units OWNER TO doadmin;

--
-- Name: units_id_seq; Type: SEQUENCE; Schema: public; Owner: doadmin
--
...
ALTER TABLE public.units_id_seq OWNER TO doadmin;

--
-- Name: units_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: doadmin
--
...
--
-- Name: mainstats id; Type: DEFAULT; Schema: public; Owner: doadmin
--
...
--
-- Name: profilepics id; Type: DEFAULT; Schema: public; Owner: doadmin
--
...
--
-- Name: scstats id; Type: DEFAULT; Schema: public; Owner: doadmin
--
...
--
-- Name: soulcards id; Type: DEFAULT; Schema: public; Owner: doadmin
--
...
--
-- Name: substats id; Type: DEFAULT; Schema: public; Owner: doadmin
--
...
--
-- Name: units id; Type: DEFAULT; Schema: public; Owner: doadmin
--
...
--
-- Data for Name: mainstats; Type: TABLE DATA; Schema: public; Owner: doadmin
--
...
228	228	5	debuffer	dark	6 8 6 8
...
315	315	3	healer	light	5 6 5 5
...
64	64	5	debuffer	water	4 4 5 9
309	309	5	buffer	water	7 7 8 9
218	218	5	debuffer	fire	8 8 7 8
314	314	5	attacker	light	6 6 7 8
252	252	5	attacker	earth	 8 8 10 9
312	312	5	buffer	dark	10 8 10 10
...
--
-- Data for Name: profilepics; Type: TABLE DATA; Schema: public; Owner: doadmin
--

...
--
-- Data for Name: soulcards; Type: TABLE DATA; Schema: public; Owner: doadmin
--

COPY public.soulcards (id, name, created_on, enabled) FROM stdin;
1	afternoon train	2020-03-01	t
2	marine idol	2020-03-01	t
3	kokoro	2020-03-01	t
4	misaki	2020-03-01	t
5	sc booster 3	2020-03-01	t
6	good moa	2020-03-01	t
7	hero	2020-03-01	t
8	high jump	2020-03-01	t
9	in the clouds	2020-03-01	t
10	lacia	2020-03-01	t
11	luna	2020-03-01	t
12	nyotengu	2020-03-01	t
13	sc booster 4	2020-03-01	t
14	strategist night	2020-03-01	t
15	time over	2020-03-01	t
16	sc booster 5	2020-03-01	t
17	secret date	2020-03-01	t
18	serious worker	2020-03-01	t
19	small assailant	2020-03-01	t
20	sweet propose	2020-03-01	t
21	test	2020-03-01	t
22	lost dream	2020-03-01	t
23	dive	2020-03-01	t
24	eternal oath	2020-03-01	t
25	7th runaway	2020-03-01	t
26	adventure of the genius	2020-03-01	t
27	afternoon nap	2020-03-01	t
28	ayane	2020-03-01	t
29	azure girl	2020-03-01	t
30	believe	2020-03-01	t
31	cake aesthetics	2020-03-01	t
32	christmas gift	2020-03-01	t
33	crossed hearts	2020-03-01	t
34	dangerous gambler	2020-03-01	t
35	dark town mistress	2020-03-01	t
36	endo siblings	2020-03-01	t
37	fluffy melons	2020-03-01	t
38	glossy peach	2020-03-01	t
39	forbidden fruit	2020-03-01	t
40	ganryu davi	2020-03-01	t
41	god have mercy	2020-03-01	t
42	halloween diva	2020-03-01	t
43	higgins daughters	2020-03-01	t
44	home-made chocolate	2020-03-01	t
45	iced americano	2020-03-01	t
46	inspiration	2020-03-01	t
47	melty christmas	2020-03-01	t
48	nobalman's new year	2020-03-01	t
49	queen of the night	2020-03-01	t
50	ppp on stage	2020-03-01	t
51	piercing blue sky	2020-03-01	t
52	go-home club	2020-03-01	t
53	i love sake!	2020-03-01	t
54	seaside goddess	2020-03-01	t
55	vacation	2020-03-01	t
56	wandering doctor	2020-03-01	t
57	wisteria tree	2020-03-01	t
58	under the rose	2020-03-01	t
59	meat together	2020-03-01	t
60	s. t. f.	2020-03-01	t
61	tranquil peace	2020-03-01	t
62	treasure hunter	2020-03-01	t
63	the power of a smile	2020-03-01	t
64	tamaki	2020-03-01	t
65	show time!	2020-03-01	t
66	sow	2020-03-01	t
67	starry stage	2020-03-01	t
68	summer night	2020-03-01	t
69	feeling tremors	2020-03-01	t
70	stray lamb	2020-03-01	t
71	extreme carnage	2020-03-01	t
72	onsen	2020-03-01	t
73	racing suit	2020-03-01	t
74	important present	2020-03-01	t
75	moon-night spa	2020-03-01	t
76	beach relaxation	2020-03-01	t
77	hero of legends	2020-03-01	t
78	hunting devil	2020-03-01	t
79	throne	2020-03-01	t
80	training expert	2020-03-01	t
81	princess carry	2020-03-01	t
82	judgement day	2020-03-01	t
83	a subaquatic date	2020-03-01	t
84	midnight partners	2020-03-01	t
85	a castle of pleasure	2020-03-01	t
86	baptism of the goddess	2020-03-01	t
87	the dream team	2020-03-01	t
88	god's dream	2020-03-01	t
89	three best friends	2020-03-01	t
90	pool-side	2020-03-01	t
91	dominus duo	2020-03-01	t
92	karma	2020-03-01	t
93	blade of hot sun	2020-03-01	t
94	ass baring devil	2020-03-01	t
95	angel's smile	2020-03-01	t
96	nightmare	2020-03-01	t
97	anniversary	2020-03-01	t
98	strategy meeting	2020-03-01	t
...
--
-- Data for Name: substats; Type: TABLE DATA; Schema: public; Owner: doadmin
--
...
28	28	Dark enemy debuff evasion rate -10%	Deals 100 damage.	Deals 381 damage to target, and Debuff debuff!EVA(-) rate -10% for 8s.	Deals 595 damage to 2 enemies with highest attack, and 70% chance to moaslide!Petrify.	Deals 2096 damage to 2 random enemies, and 90% chance to moadrive!Petrify.	A PVP cc unit and great in combination with $'Wola'. Also great with DoT teams and $'Gkouga'. Moa is great at stalling the enemies to get to fever/drive first. Useless in Raids and WorldBoss.
...
51	51	+12% Defense to all allies.	Deals 92 damage.	Deals 316 damage to target, and gives a Barrier +800HP for 10s to 2 allies with the lowest HP.	Deals 563 damage to target, gains aurorakingslide!Fury to self and +35% defense to all allies for 14s.	Deals 1469 damage to 2 enemies, gives Barrier +2500 and Drive-Defense +30% for 15s to 5 allies with the lowest HP.	a.k.a Slime boie. H A I L S L I M E K I N G.
...
56	56	Recovery amount (Heal and Regen) +5% to Wood type allies	Deals 96 damage.	Deals 335 damage to target and gives syrinxtap!Fortitude to 1 ally with highest attack.	Gives 141HP Regen for 14s and syrinxslide!Fortitude to 2 allies with lowest HP.	Gives 199HP Regen for 16s and syrinxdrive!Fortitude to 3 allies with lowest HP.	Syrinx doesn't have the strongest heals per tick, but her Fortitude bubbles is her greatest asset that it completely negates any damage no matter how high. In PVP her buff can help negate damage but when faced with DoTs, they destroys Fortitude stacks much faster. Best healer/tank combo.
...
60	60	Heal and Regeneration amount +5% to Light units	Deals 95 damage.	Deals 330 damage to target, and removes Freeze and Petrify debuffs from 1 ally.	Gives 146HP Regen for 20s to all allies.	Revives 1 dead ally to 1000HP and gives 300HP Regen for 16s to 3 allies with lowest HP.	Only child that can heal the whole team in WB. Maat + $'Leda' combos are really strong, especially with Leda's leader skill. Maat is very useful in PVE and can be a real annoyance for the enemy in PVP. Her auto taps too much unfortunately.
...
64	64	Drive Gauge Charge -5% to all enemies (Additional 8% on Worldboss).	Deals 101 damage	Deals 381 damage to target and apply tethystap!Poison for 2 turns. Within 8s debuff effect on 2 enemies will have it's duration extended by 30% (from current remaining duration).	Deals 617 damage to 2 random enemies and 70% chance to remove 1 buff from the target (last applied buff).\r\nApply Debuff-Explosion.	Deals 1983 damages to 3 random enemies and apply Poison for 3 turns.	Skill reserve (on tap only) made her the best poison enabler for WB to run
...
88	88	+10% Debuff debuff!EVA for Light Allies | Additional +10% in Ragna.	Deal 100 damage.	Deal 380 damage & 70% chance to remove Death-Heal from 2 allies.	Deal 660 damage to target. Attack +1600 and Slide Skill Damage +1200 for 3 Light Allies (Prioritizing Highest ATK) for 16 seconds. In Ragna only, Skill Gauge +20% for 2 Light type Allies.	Deal 1758 damage to 3 enemies. Attack +40% for 20 seconds and apply "Silence Immunity" for 10 seconds to 2 Allies (Prioritizing highest ATK).	
...
185	185	Regen Amount +15% for all water type allies [For PvP only, Skill CD -1s]	Deals 96 damage	Deals 335 damage to target, 70% chance to remove Heal-Block from 2 allies affected by it and apply Regen 101 HP  to 2 lowest health allies for 8s	Deal 513 damage to target, prioritizing 3 allies with the lowest HP, apply Regen 352 HP for 8s, and if affected by a DoT debuff, apply an additional 120 HP Regen for 14s	Deal 1543 damage to 2 enemies, prioritizing 3 allies with the lowest HP, Regen 220 HP for 16s and Regen Amount +50%	Limited Blazblue Centralfiction event collab. Only decent in PvP, meh everywhere else. 
191	191	Slide Skill defense +5% to Light Allies	Deals 92 damage.	Deals 319 damage to target and gain Debuff-Immunity for 3s.	Deals 578 damage to target and grant Barrier +1400 HP and +35% Defense for 14s to 5 allies with lowest HP.	Deals 1480 damage to 2 random enemies and give Drive-Defense +30% for 15s to all allies.	Dana is the best tank in the game in all modes, except WorldBoss where $'Maris' (water tank) is better. Her shields + defense up helps to survive against raid drives. Running Dana with a single healer like $'Maat' or $'Leda' will give your team high survivability. VA: Risa Taneda\r\n
...
206	206	Excluding self, resurrect the first ally that dies with 50% HP (1 time only)	Deals 96 damage.	Deal 337 damage to enemy, for 20 seconds Heal-Amount +30% to 3 allies with lowest HP.	Heals 1291 HP and grants Barrier +1400 HP to 3 allies with the lowest HP for 14 seconds.	Deals 1549 damage to 2 random enemies, and heals 1791 HP and Regen 220 HP to 3 allies with lowest HP for 16 seconds.	Her leader skill doesn't work if used as a friend support.
...
209	209	Final drive skill damage for all enemies -25% (Additional, deduce DoT debuff damage -50% in Devil Rumble).	Deal 102 auto attack damage.	Prioritizing enemies with buffs, deal 399 damage to target, apply Debuff debuff!EVA(-) -10% for 20 seconds and defense -10% for 8 seconds.	Prioritizing enemies with the least HP, deal 702 damage to 2 enemies, apply bathory!Dancing-Blade for 14 seconds and Defense -700 .	Prioritizing enemies with many buffs, deal 2089 to 3 enemies and apply bathory!Stigma for 20 seconds.	A must need in PvP
...
216	216	Fire type allies Slide Skill Defense +12%\r\n	Deals 92 damage	Deals 317 damage to target, apply keinotap!Taunt and +800 Slide-Skill-Defense for 10 seconds	Deals 588 damage to 2 random targets, for only 3 fire type allies, (Priority: highest attack) 70% chance to remove and be Invulnerable to disabling debuffs and gives Barrier (+1800HP)  for 14 seconds	Deal 1496 damage to 2 random targets, apply keinodrive!Taunt and keinodrive!Reflect for 20 seconds	Requires running at least 2 other fire type allies on a team to maximize her usefulness
221	221	ATK +15% to Water allies (For WB only, ATK +15% to all allies)	Deals 114 damage	Deal 494 damage to target, 70% to apply Heal-Block for 8s. For WB only, 70% chance to gain justicemafdettap!Awaken to self for 15s	Prioritizing enemies with debuffs, deals 960 damage and 400 Ignore Defense damage 2 times to 2 targets, on Fire type targets, deal 350 Bonus damage 	Deals 2603 damage to 4 random enemies.	Best Lead for Fire WB at the moment
...
217	217	Skill Gauge Charge Amount -15% for all Fire type enemies	Deals 102 damage	Deals 394 damage to target, Skill Gauge -30%	Prioritizing lowest HP enemies, deals 675 damage and 600 Denfese Ignore damage to 2 enemies. Apply Water-Snake for 12s	Deal 2031 damage to 3 random enemies, apply Heal-Block and Tsunami.	Water Snake debuff damage explanation: +40% damage if the debuffed target is a Fire type, while -40% damage if the debuffed target is a Wood type; otherwise, its the damage written on the skill. At +6 Water-Snake debuff hits for 1605 damage. Very likely to be useful in the upcoming Fire WB
...
227	227	Dark type allies Skill gauge charge amount  +12%	Deals 100 damage	Deal 379 damage to target, for 2 debuffed allies, 60% chance to cleanse 1 debuff	Deal 663 damage to target, to 2 allies with the highest attack, skill gauge charge amount +36.5% and Debuff debuff!EVA +20% for 16s	Deal 2040 damage to 3 random targets, prioritizing dark type childs, skill gauge charge amount +50% and tap skill damage +1500 to 3 allies for 20s	
228	228	Light type enemies Debuff Accuracy -15%	Deals 102damage	Deal 396 damage to the highest attack enemy, apply alterdavislide!Blind to target for 10 seconds.	Prioritizing Debuffer types, deal 677 damage to 2 targets, Apply alterdavidrive!Blind and Debuff-Accuracy -20% for 12s	Prioritizing lowest HP enemies, deal 2038 damage to 3 enemies, 80% chance to inflict Death-Heal and 80% chance to apply Attraction for 16s.	
229	229	Light type allies Skill gauge charge amount +12% (During Ragna, Light type allies Skill gauge charge amount +8% additional)	Deals 101 damage	Deal 390 damage to target, to 2 lowest HP allies, grant lightmonatap!Barrier +900 for 10s	Deal 679 damage to target, to 3 light type allies with the highest attack, skill gauge charge amount +40% and Final Weak point damage +20% for 16s. For Ragna, grant lightmonaslide!Vampirism to 3 allies with the lowest HP for 16s	Deal 1828 damage to 3 random targets, to 5 allies, grant Barrier +2500 HP for 20s and Drive gauge +120 for every Light type ally (up to 5)	
...
226	226	All Allies Def +15% (During Ragna, Weak Point Skill damage +12% for Fire allies)	Deals 92 damage	Deal 319 damage to target, prioritizing lowest HP allies, grant Barrier (+800 HP) to 2 targets for 10s. During Ragna, Heal 9%+26HP to self	Deal 591 damage to target, gains catherine!Taunt and Immortality for 10s. During Ragna, apply catherine!Life-Bind to self for 12s	Deal 1501 damage to 2 random targets, prioritizing lowest HP allies, grants catherine!Reflect to 5 allies for 20s	Only good in Fire Ragna for her lead, and if you need more survivability.
232	232	Water type allies Tap Skill Damage +12% (For WB only, water type allies Skill Gauge Amount +20%)	Deals 101 damage	Deal 393 damage to target, for 2 allies that are stunned, 70% chance to remove stun	Deal 706 damage to target, for 3 highest attack water type allies, +40% Skill Gauge Amount and +15% ATK. For WB only, prioritizing water type allies in the back row, Skill Damage +20% for 5 allies	Deal 1832 damage to 3 random enemies, prioritizing highest attack water type allies, Tap skill damage +50% for 5 allies for 20s. For WB only, grants Attack-stance to 5 highest attack water type allies	a.k.a - gilteen, guillotine, guiltine. 
231	231	Fire type allies Agility +15%	Deals 113 damage	Deal 490 damage to target, +20% Agility to self for 14s	Prioritizing 3 lowest HP enemies, deal 933 damage, apply 148 damage per buff (up to 8 applications). Apply zivaslide!Heal-Buff-Explosion.	Deal 2545 damage to all enemies, apply zivadrive!Heal-Buff-Explosion.	
224	224	Water type enemies ATK -15% 	Deals 102 damage	Deal 394 damage to target, DEF -500 to target for 10s	Deal 675 damage to 2 random targets. 65% chance of to apply Attraction for 12 seconds. To 1 target, 70% chance to apply skill!Target	Deal 2031 damage to 3 random targets, apply Blind to target for 16 seconds. Drive Skill Gauge -12%	
244	244	Drive skill damage +10% to Water units	Deals 113 damage.	Deals 485 damage to target with lowest defense, on Fire type enemies, deal 250 Bonus damage	Deals 855 damage plus 450 bonus damage and eve!Poison for 3 turns to 2 enemies with lowest HP.	Deals 2437 damage to all enemies.	She is great starter pick all content. Though, at lower uncap levels she will not be as great as $'Elysium' or $'Sonnet' in regards to poison, but she does more raw damage. 
...
236	236	Wood type allies Slide skill damage +10%	Deals 113 damage	Deals 487 damage to target, 70% chance to swap Attack and Defense for 14s to self	Prioritizing Debuffer types, deals 930 damage to 2 targets, apply piercingruin!Erode for 20s. For PvP only, apply piercingruin!Shatter.	Deal 2539 damage to 4 random enemies	
...
234	234	Wood type enemies Def -10%	Deals 74 damage	Deal 245 damage to target, target’s Def -350 for 8s	Deal 446 damage to 2 random enemies, 42% to apply Stun for 4s.	Prioritizing stunned enemies, deal 1115 damage to 3 targets, if the target is stunned, deal 500 ignore def damage.	
241	241	Skill Gauge Charge Amount+8% to Wood Allies	Deals 99 damage.	Deals 368 damage to target and gives +150 skill gauge to 2 Wood type attackers.	Deals 578 damage to target and gives +30% skill gauge charge amount and debuff duration -20% (excluding petrification) for 15seconds to 3 wood type allies.	Deals 1673 damage to 3 random enemies and 70% chance to apply Stun for 14s and gives brownie!Vampirism to 3 lowest HP allies. 	
239	239	Water type allies Slide Skill Defense +12%	Deals 93 damage	Deals 322 damage to target, prioritizing 2 lowest HP allies, give Max HP +850 for 8s	Deals 606 damage to target, for 3 lowest HP Water type allies, apply pakhetslide!Ice-Shield and Max HP +1400 for 14s	Deal 1536 damage to 3 random enemies, grant Taunt to herself and apply pakhetdrive!Ice-Shield for 16s	
242	242	Wood type allies Debuff debuff!EVA +15%	Deals 242 damage	Deals 1124 damage to target, 62.7% chance to remove a debuff from 3 Wood type allies	Deals 1538 damage to target, prioritizing 2 lowest HP allies, apply Regen 2.2% HP + 74 for 14s and 5 Wood type allies + 14.1% Debuff debuff!EVA	Deal 3971 damage to 2 random enemies, prioritizing 3 lowest HP allies, heal 2018 HP and if allies are debuffed, apply Regen 370HP for 16s	
...
245	245	Poison damage +200 for Water type allies	Deals 113 damage	Prioritizing poisoned target, to one target, deal 430 damage 2 times	Prioritizing lowest HP enemies, deal 905 damage and 700 Ignore Defense damage to 3 targets. Apply salomeslide!Poison for 2 turns	Deal 2487 damage to 4 random enemies, on poisoned targets, deal 500 Bonus damage	Has higher poison damage than both $'Eve' and $'Thanathos' (on equal uncaps). 5* version of $'Elysiun' (time for her to retire). Made Chiyu not f2p on JP anymore xAx. 2/13 UPDATE: poison damage dethroned by $'Serket'
252	252	Wood type allies Critical Rate +18% [In Ragna only, Critical Damage +40%]	Deals 114 damage	Deals 494 damage to target, on water type enemies, deal 350 Bonus damage. On a critical hit, apply annietap!Vampirism to self for 20s	Prioritizing 1 target with the lowest HP, deals 960 damage and 680 Denfese Ignore damage 3 times and on a debuffed target, deal 550 bonus damage. In Ragna only, on a critical hit, deal 5000 fixed damage.	Deal 3756(300%) damage to a random enemy, Skill Damage +40% to self for 20s	Excels in Water Ragna. Successfully powercreeped JCB (Jiseihi) in Ragna when paired with crit 
258	258	Light type allies Skill Damage Defense +10% 	Deal 69 damage \r\n\r\n\r\n	Deal 190 damage 2 times to target. Inflict Blind to 1 Enemy with the highest attack for 6s	Deal 406 damage, grant gomorrahslide!Reflect to self for 14s and Skill Damage Defense +12% (for 14s or 2 hits) to 3 allies excluding itself\r\n	Deal 835 damage to 2 random enemies, grant gomorrahdrive!Reflect to 5 random allies for 16s	
...
250	250	-15% Debuff Evasion for Wood enemies.	Deal 102 auto attack damage.	Prioritizing enemies with Fortitude buff, deal 394 to 2 enemies and a 75% chance to remove Fortitude buff from targets.	Prioritizing debuffer type enemies, deal 674 to 2 enemies, a 60% chance to apply Stun for 4 seconds, -800 Agility(-) for 12 seconds. 	Deal 2029 to 3 random enemies. For 2 turns, apply +2 seconds on enemy Slide Skill Cooldown, and enemy's Drive Gauge -12%.	Leader Skill used in WB
...
253	253	Fire type enemies Skill Gauge Charge Amount -10%	Deals 102 damage	Deals 398 damage to target, apply Drive skill defense -20% for 10s	Prioritizing tanks, deal 690 damage to 2 enemies, skill gauge -35% and apply methuselah!Snow-Bomb.	Deal 2064 damage to 3 random enemies, enemy Drive gauge -15% and 80% chance to apply Stun for 16s	
...
254	254	Wood type allies Attack +18% (For WB only, all allies Attack +20%)	Deals 114 damage	Deals 498 damage to target, for 2 turns, attack +20% to self	Deals 625(135%) damage to 3 random enemies, For WB only, deal additional 1900 Ignore Defense damage	Deal 2661 damage to 4 random enemies, apply hel!Vampirism to self	Fact: Hel currently has the highest base attack stat in the game
...
301	301	Light allies heal and regeneration amount +15%. 	Deals  96 damage. 	Deals 337 damage to target, gives Debuff EVA(+)  +15% to 2 allies with the lowest HP. 	Prioritizing 2 allies with the lowest HP, Regen 191 HP and gain Debuff-Immunity for 14 seconds. 	Revives 1 dead ally to 1000HP and Heal 1791HP to 3 allies with the lowest HP. 	Her ability to cleanse all manner of debuffs can make event bosses with nasty debuff mechanics difficulty trivial. She also has a revive in her drive in case a child dies.
310	310	Wood type allies Skill Gauge Charge Amount +15%(For Ragna only, Skill Gauge Charge Amount additional +10%)	Deals 101 auto damage.	Deals 393 damage to target, for 2 highest attack allies, skill gauge +17%. \r\nFor Ragna only, for one highest attack wood ally, 45% chance to Apply fancysitritap!Concentration for 20s	Deals 705 damage to target, for 3 highest attack wood allies, Slide Skill damage +25% and Skill Gauge Charge Amount +45% for 16s. \r\nFor Ragna only, prioritizing 3 allies with time speed debuffs, 70% chance to apply fancysitrislide!Time-distortion	Deal 1830 damage to 3 random enemies, for 3 allies with the lowest HP, heal 2029 HP and Drive gauge +150 for every Wood type ally (up to 5).	:sitriLick:
...
307	307	Wood type allies Drive Defense +15% (for PvP only, additional +20%)	Deals 93 damage	Deals 322 damage to target, for the highest wood type ally, grant Immortality for 10s	Deals 593 damage to target, for 3 lowest HP allies, 56% chance to grant Immortality for 14s and for 3 lowest HP Wood allies, Max HP +1600 for 14s	Deal 1511 damage to 2 random enemies, 95% chance to give Immortality to self for 16s. rafflesdrive!Taunt for 16s. 70% chance to give Debuff-Taunt to self	
...
311	311	Fire type allies Slide Skill Damage +12%(For WB only, Slide Skill Damage additional +12%)	Deals 113 damage	Deals 492 damage to target, for WB only, grant Skill Damage +25% to self for 14s	Deals 959 damage 2 times and 400 Ignore Defense damage to 2 random enemies. If the target is Wood type, deal 350 Bonus damage. For WB only, apply sweetledaslide!Protection-buff-explosion.	Deal 2601 damage to all enemies, for WB only, apply sweetledadrive!Protection-buff-explosion.	Same type of buff explosion as $'Ophois'
308	308	Water type enemies -15 Debuff Evasion [For WB only, Weak Point Defense -15%]	Deals 102 damage	Deal 394 damage to target, Weak-point-Defense -13% for 10s	Prioritizing Water type enemies, deal 675 damage to 2 targets. Debuff debuff!EVA(-) -15%, Debuff duration extended by 23% for 12s. For WB only, Weak-Point-Defense -1.5% for every Wood allies in the party (max times 10) for 12s	Deal 2031 damage to 3 random enemies. Weak-Point-Defense -30% and Debuff duration extended by 40% for 16s	
305	305	Fire type allies Tap skill damage +15% (For Ragna only)	Deals 114 damage	Deals 492 damage to target 3 times, deal 500 Ignore defence damage, and for Wood type targets, deal 350 Bonus damage. For Ragna only, 70% chance to apply firedavitap!Overload to self for 14s	Deals 961 damage to 3 random enemies, apply firedavislide!Fortitude-Explosion.	Deal 2607 damage to all enemies, for Attacker types, deal 700 Bonus damage Lead	
...
314	314	Attack type allies slide skill cooldown reduced by 1 second	Deals 113 damage	Deals 492 damage to target, 65% chance to grant Cheer to self for 15s	Deals 958 damage to 2 enemies with the lowest HP, deals 1300 ignore DEF damage. For WB only, deal Hope-passage	Deal 2600 damage to all enemies	
313	313	All enemies debuff evasion -12%	Deals 102 damage	Deals 394 damage to target, target’s Debuff debuff!EVA(-) -15% for 10 seconds. 	Prioritizing 2 lowest HP targets, deal 674 damage, apply iphisslide!Damage-Resonance for 12 seconds and 70% chance of remove one buff from target. 	Deal 2029 damage to 3 enemies, apply iphisdrive!Damage-Resonance for 16 seconds. 	Good lead for any WB and slide remove a buff.
218	218	Wood type enemies Debuff accuracy -15%	Deals 102 damage	Prioritizing enemies with Bleed, deal 396 damage to 1 target. 65% chance to inflict Wounded for 12 seconds.	Prioritizing Support type enemies, deals 677 damage and 600 Defense ignore damage to 2 targets, apply tamamoslide!Bleed for 12 seconds.	Prioritizing Attacker type enemies, deals 2036 damage to 3 targets. Remove one buff from enemy and 80% chance to apply Attraction for 16 seconds.	A slightly better version of Jupiter
243	243	Water type allies Slide Skill Damage +12%	Deals 113 damage	Prioritizing target with the lowest HP, deal 490 damage to 1 target, 70% chance to disable Protection type buffs for 8s	Prioritizing debuffed enemies, deals 993 damage to 1 target 3 times, deals 400 Bonus damage and prioritizing 2 lowest HP enemies, apply serket!Poison for 3 turns	Deal 2547 damage to 4 random enemies, 80% chance to remove one buff	New Highest Poison for WB (1644 at +6)
...
38	38	Skill gauge speed +12% to wood allies [For UG only, all allies +15% attack]	Deals 100 damage	Deals 385 damage to target. 70% chance to remove Defense-down debuffs from 2 allies.	Deals 675 damage to target. For 16 seconds, apply Max HP +1600 (Priority: Lowest HP) to 2 allies, 70% chance to apply botanslide!Time-Distortion and [For UG only, gives +15% attack 2 allies with highest attack.]	Deals 1764 damage to 3 enemies. To the ally with the highest attack, gives botandrive!Berserk for 20s and prioritizing grass allies, 3 allies Skill Gauge Charge Amount +50%	
255	255	Water type allies Slide Skill CD -1s  (For PvP only, debuff duration -40% for all allies)	Deals 96 damage	Deals 342 damage to target, for 2 lowest HP allies, apply Barrier +900 and Heal amount +35% for 10s	Deals 542 damage to target, for 2 lowest HP allies, apply Regen 2.1%+21 HP for 14s, and for 3 lowest HP water type allies, 70% chance to apply cuteeuros!Invulnerability to disabling debuffs  for 14s	Deal 1606 damage to 2 random enemies, for 3 lowest HP allies, Instant heal 1892 and cleanse all debuffs	
312	312	Dark type allies critical rate +20% (For WB only, critical damage +40%)	Deals 101 damage	Deals 394 damage to target, 70% chance to apply Awaken for 2 attacker type allies for 15s and for 2 allies with the most HP, 70% chance to apply immunity to stun for 8s	Deals 718 damage to 2 random enemies, for 3 attacker type allies, critical rate +48% and critical damage +45% for 2 turns. For WB only, Slide skill damage +50% to 5 dark attacker type allies	Deal 1858 damage to 3 random enemies, for 5 attacker type allies, tap skill damage +80% for 20s. For WB only, grant Attack-stance to 5 dark type attacker allies	Welcome to the land of powercreep~
302	302	Skill Gauge Charge Amount +8% to Water type Allies.	Deals 100 damage.	Deals 381 damage to target and 52.5% chance to fully charge skill gauge to random ally (excluding self).	Deals 663 damage to target and Skill Gauge Charge Amount +40% for 2 turns and Slide Skill Cooldown -2 seconds to 2 allies with highest attack.\r\n	Deals 1789 damage to 3 random enemies and 80% chance to Stun for 12s and +400 drive gauge.	Kouga is the best support unit in the game and a must have. Her buffs can help attackers deal more damage or help your team survive by targeting a healer on the team - Healers have long cooldowns, so Kouga is great at decreasing it with her slide. Her tap is usually more RNG even at +6 uncap, and even at 83% she will not activate her tap passive skill if spammed. The tap skill will also only fully charge an ally's skill gauge if they are not on a counter cooldown, so use it wisely. On drive, +400 drive gauge is 13% of the drive gauge (excluding during WB). VA: Kana Hanazawa\r\n
...
100	100	Defense -15% to Wood enemies.	Deals 101 damage.	Deals 390 damage, 75% chance of removing one buff from target.	Prioritizing enemies with the lowest HP, deal 647 to 2 targets, and demeterslide!Deadly-Poison for 10 seconds.	Prioritizing enemies with Deadly-Poison, deals 1998 damage to 3 enemies, Defense -30% and 90% chance of Deadly-Poison-Amplification for 16 seconds.	At +6, Deadly-Poison deals 904 damage per tick and with her SC #'Lost Dream' at +5 it add another 260 on top of that. One of the scariest DoTs in PvP and can only be countered with cleanse or Bathory.
...
315	315	Light Type allies Heal Amount +6%	Deal 52 damage	Deal 146 Damage, Instant Heal 83 HP to 1 ally with the lowest HP	Prioritizing lowest HP allies, Instant Heal 207 HP and 35% chance to remove DOT Debuffs for 2 allies	Prioritizing lowest HP allies, Instant Heal 381 HP and 70% chance to remove DOT Debuffs for 3 allies	
90	90	Light type allies +15% Attack. [During Ragna, Weak Point Skill Damage +10%]	Deals 113 damage. 	Deals 491 damage to target. On Dark type targets, deal 250 Bonus damage	Prioritizing lowest HP enemies, deal 958 damage to 2 target, 1300 Ignore Defense damage. On Dark type targets, deal 1050 Bonus damage.	Deals 1764 damage to all enemies. Apply Concentration to self. 	Very good child against Dark attribute bosses due to being able to use Crit Fever when her drive is used. Slightly beats $'Cleopatra' for use in Dark Ragna
210	210	Skill Gauge Charge Amount -15% for all Debuffer type enemies [For PvP only, Skill Gauge Charge Amount -5% to all enemies]	Deals 102 damage	Deals 396 damage to target, apply Skill Gauge Charge Amount -20% for 10s	Prioritizing Debuffer types, deals 677 damage to 2 enemies, 70% to reset enemy skill gauge and apply Heal-Block for 12s	Prioritizing targets with Debuffs, deal 2036 damage to 3 enemies, Debuff-Explosion and for 16 seconds apply Burn and apply Scald (During Burn's effect, Scald is reapplied every time the target receives an attack except during Fever Time). 	Limited Blazblue Centralfiction event collab. She is a 9 (hehe) in PvP, meh everywhere else. Good counter for grass debuffers (coughBathorycough).
230	230	Slide Skill Damage for Dark type allies +10%	Deals 114 damage	Prioritizing 2 lowest HP enemies, deal 440 damage, apply Anti-Barrier	Prioritizing Light types, deal 961 damage to 2 targets, 2 times, apply ophoisslide!Protection-buff-Explosion. For PvP only, deal 600 bonus damage	Prioritizing enemies with protection type buffs, deal 2605 damage to 4 enemies, apply ophoisdrive!Protection-buff-Explosion.	Protection Type Buff includes. DEF Up,\r\nSkill Defense Up,\r\nTap Skill Defense Up,\r\nSlide Skill Defense Up,\r\nDrive Skill Defense Up,\r\nDEF Up stacks,\r\nImmortality,\r\nFortitude,\r\nBarrier,\r\nTaunt,\r\nDebuff Taunt,\r\nPain Adaptation,\r\nMax HP Up. More info on "type of buff" damage multiplier can be found here: https://ginmy.net/dc_ophois_inspection 
184	184	Attack +10% to Light Allies	Deals 113 damage.	Deals 477 damage to target. On Dark type targets, deal 100 Bonus damage. 55% chance to Apply Concentration to self for 13 seconds.	Deals 927 damage plus 800 Ignore Defense damage to 2 lowest HP enemies and apply cleopatra!Curse for 8 seconds 	Deals 2327 damage to 4 lowest HP enemies and on Cursed targets, deal 500 Bonus damage	A strong attacker in all content. Great against Dark Raids where her self-crit buff will allow all damage during fever to crit - Damage monster (downside is that buff is purely rng). Her slide also inflicts DoT and targets lowest health making her very good in pvp as well. Best Light attacker overall.
66	66	Skill Gauge Charge Speed +8% to all Allies (Additional +8% in Devil Rumble).	Deals 101 damage.	Deals 379 damage to target. 50% chance to cleanse DoTs from 2 allies. Gives newbiemonatap!Vampirism for 14s to 2 allies.	Deals 667 damage to 2 random enemies. +30% Skill Gauge Charge-Speed for 2 turns to 2 highest attack allies. 70% chance to apply Cheer for 2 turns to 2 highest attack allies.	Deals 1803 damage to 3 random enemies.\r\n+40% Skill Gauge Charge Amount for 3 turns to 3 allies (prioritizing Wood types). \r\nApply Cheer for 3 turns to 3 allies (prioritizing Wood types).	Great in all content and can easily replace $'Kouga' when skill cooldown isn't as important as speed buff and damage buff. Can be used with Kouga to get a really speedy team.
\.


--
-- Data for Name: units; Type: TABLE DATA; Schema: public; Owner: doadmin
--
...
--
-- Name: mainstats_id_seq; Type: SEQUENCE SET; Schema: public; Owner: doadmin
--

SELECT pg_catalog.setval('public.mainstats_id_seq', 315, true);


--
-- Name: profilepics_id_seq; Type: SEQUENCE SET; Schema: public; Owner: doadmin
--

SELECT pg_catalog.setval('public.profilepics_id_seq', 315, true);


--
-- Name: scstats_id_seq; Type: SEQUENCE SET; Schema: public; Owner: doadmin
--
...
--
-- Name: soulcards_id_seq; Type: SEQUENCE SET; Schema: public; Owner: doadmin
--
...
--
-- Name: substats_id_seq; Type: SEQUENCE SET; Schema: public; Owner: doadmin
--

SELECT pg_catalog.setval('public.substats_id_seq', 315, true);


--
-- Name: units_id_seq; Type: SEQUENCE SET; Schema: public; Owner: doadmin
--

SELECT pg_catalog.setval('public.units_id_seq', 315, true);


--
-- Name: mainstats mainstats_pkey; Type: CONSTRAINT; Schema: public; Owner: doadmin
--
...
--
-- Name: profilepics profilepics_pkey; Type: CONSTRAINT; Schema: public; Owner: doadmin
--
...
--
-- Name: scstats scstats_pkey; Type: CONSTRAINT; Schema: public; Owner: doadmin
--
...
--
-- Name: soulcards soulcards_pkey; Type: CONSTRAINT; Schema: public; Owner: doadmin
--
...
--
-- Name: substats substats_pkey; Type: CONSTRAINT; Schema: public; Owner: doadmin
--
...
--
-- Name: units units_pkey; Type: CONSTRAINT; Schema: public; Owner: doadmin
--
...
--
-- Name: mainstats mainstats_unit_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: doadmin
--
...
--
-- Name: profilepics profilepics_unit_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: doadmin
--
...
--
-- Name: scstats scstats_sc_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: doadmin
--
...
--
-- Name: substats substats_unit_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: doadmin
--
